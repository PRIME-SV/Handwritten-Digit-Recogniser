...
# confirm whether everything is loaded correct
...
def display_dataset():
    # function to display the given dataset
    cols = 5
    num_classes = 10
    num_of_samples = []
...
checkpoint = ModelCheckpoint(
    'model-{epoch:03d}.model', monitor='val_loss', verbose=0, save_best_only=True, mode='auto')  # to save the best model


history = model.fit(X_train, y_train, epochs=10,  validation_split=0.1,
                    batch_size=400, verbose=1, shuffle=1, callbacks=[checkpoint])
